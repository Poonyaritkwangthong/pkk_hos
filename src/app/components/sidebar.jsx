...
export default function SideBar() {
  const [field, setField] = useState({
    ...
    user_role: "หล่อ",
    profile_img:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTEhCfQFYlf_03NRCv53FFo1aE22_shmhW10Q&s",
  });
  return (
    <div>
      <aside
      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-white">
          ...
          <div>
            <ul>
              <div className="mb-4">
                {field?.user_role === "หล่อ" || field?.user_role === "หมอ" || field?.user_role === "หมอ hiv" || field?.user_role === "หมอ bc" ? (
                  <li>
                    <a href="/dashboard">
                ...
                {field?.user_role === "หมอ bc" || field?.user_role === "หล่อ" ? (
                  <li>
                    <a href="bc">
